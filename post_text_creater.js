...
const createText = async () => {
    ...
    let txt7 = `Average ${oilSynonyms()} prices in Long Island ${LIC == 0 ? holdSteadySynonyms() + ` at $${(Number(LIA)).toFixed(2)}` : (LIC > 0 ? roseSynonyms() : fellSynonyms()) + ` from $${((LIA - LIC).toFixed(2))} to $${(Number(LIA)).toFixed(2)}`} ${inTheLastSynonyms()} seven days.\n${LIC == 0 ? "Over the longer term, in the last month," : "This " + ((LIC > 0 && p6 - p1 > 0) || (LIC < 0 && p6 - p1 < 0) ? continuesSynonyms() : reversesSynonyms()) + " the longer term 30-day trend where"} Long Island ${residentsSynonyms()} have seen the price per gallon ${p6 - p1 == 0 ? holdSteadySynonyms() + " at $" + (Number(LIA).toFixed(2)) : (`of ${oilSynonyms()} ${p6 - p1 > 0 ? riseSynonyms() : fallSynonyms()} by ${Math.round(Math.abs(p1 - p6) * 100)} cents`)}.\n`;
  
    let txt8 = toTitleCase(`New York ${oilSynonyms()} Price Trends`);
    let txt9 = `Average ${oilSynonyms()} prices in New York ${NYC == 0 ? holdSteadySynonyms() + ` at $${(Number(NYA)).toFixed(2)}` : (NYC > 0 ? roseSynonyms() : fellSynonyms()) + ` from $${((NYA - NYC).toFixed(2))} to $${(Number(NYA)).toFixed(2)}`} ${inTheLastSynonyms()} seven days.\n${NYC == 0 ? "Over the longer term, in the last month," : "This " + ((NYC > 0 && p6 - p1 > 0) || (NYC < 0 && p6 - p1 < 0) ? continuesSynonyms() : reversesSynonyms()) + " the longer term 30-day trend where"} New York ${residentsSynonyms()} have seen the price per gallon ${p6 - p1 == 0 ? holdSteadySynonyms() + " at $" + (Number(NYA).toFixed(2)) : (`of ${oilSynonyms()} ${p6 - p1 > 0 ? riseSynonyms() : fallSynonyms()} by ${Math.round(Math.abs(p1 - p6) * 100)} cents`)}.\n`;
    
    let txt10 = toTitleCase(`Massachusetts ${oilSynonyms()} Price Trends`);
    let txt11 = `Average ${oilSynonyms()} prices in Massachusetts ${MC == 0 ? holdSteadySynonyms() + ` at $${(Number(MA)).toFixed(2)}` : (MC > 0 ? roseSynonyms() : fellSynonyms()) + ` from $${((MA - MC).toFixed(2))} to $${(Number(MA)).toFixed(2)}`} ${inTheLastSynonyms()} seven days.\n${MC == 0 ? "Over the longer term, in the last month," : "This " + ((MC > 0 && p6 - p1 > 0) || (MC < 0 && p6 - p1 < 0) ? continuesSynonyms() : reversesSynonyms()) + " the longer term 30-day trend where"} Massachusetts ${residentsSynonyms()} have seen the price per gallon ${p6 - p1 == 0 ? holdSteadySynonyms() + " at $" + (Number(MA).toFixed(2)) : (`of ${oilSynonyms()} ${p6 - p1 > 0 ? riseSynonyms() : fallSynonyms()} by ${Math.round(Math.abs(p1 - p6) * 100)} cents`)}.\n`;
    
    let txt12 = toTitleCase(`Connecticut ${oilSynonyms()} Price Trends`);
    let txt13 = `Average ${oilSynonyms()} prices in Connecticut ${CC == 0 ? holdSteadySynonyms() + ` at $${(Number(CA)).toFixed(2)}` : (CC > 0 ? roseSynonyms() : fellSynonyms()) + ` from $${((CA - CC).toFixed(2))} to $${(Number(CA)).toFixed(2)}`} ${inTheLastSynonyms()} seven days.\n${CC == 0 ? "Over the longer term, in the last month," : "This " + ((CC > 0 && p6 - p1 > 0) || (CC < 0 && p6 - p1 < 0) ? continuesSynonyms() : reversesSynonyms()) + " the longer term 30-day trend where"} Connecticut ${residentsSynonyms()} have seen the price per gallon ${p6 - p1 == 0 ? holdSteadySynonyms() + " at $" + (Number(CA).toFixed(2)) : (`of ${oilSynonyms()} ${p6 - p1 > 0 ? riseSynonyms() : fallSynonyms()} by ${Math.round(Math.abs(p1 - p6) * 100)} cents`)}.\n`;
